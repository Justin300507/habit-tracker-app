...
const Sidebar = () => (
  <aside className="w-56 bg-slate-900 text-slate-200 flex flex-col px-3 py-4 fixed h-full">
    ...
    <nav className="flex-1 space-y-0.5">
      ...
      <NavLink to="/habits" className={({isActive}) => `flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${isActive ? 'bg-indigo-600 text-white' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}`}>
        <ListTodo size={16} />
        Habits
      </NavLink>
    </nav>
